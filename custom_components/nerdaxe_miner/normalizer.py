...
def normalize_miner_payload(
    ...
    return MinerSample(
        ...
        manual_fan_speed=to_float(pick_first(payload, ("manualFanSpeed",))),
        auto_fan_speed=to_bool(pick_first(payload, ("autofanspeed",))),
        fan_rpm=to_float(pick_first(payload, ("fanrpm", "fanRpm"))),
        pid_target_temp=to_float(pick_first(payload, ("pidTargetTemp", "temptarget"))),
        overheat_temp=to_float(pick_first(payload, ("overheat_temp",))),
        ...
        actual_frequency=to_float(pick_first(payload, ("actualFrequency",))),
        default_frequency=to_float(pick_first(payload, ("defaultFrequency",))),
